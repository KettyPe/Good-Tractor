(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".cards__slider")) new core(".cards__slider", {
            ...
            navigation: {
                prevEl: ".cards__arrow_prev",
                nextEl: ".cards__arrow_next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
        ...
        if (document.querySelector(".news__slider")) new core(".news__slider", {
            ...
            navigation: {
                prevEl: ".news__arrow_prev",
                nextEl: ".news__arrow_next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
        ...
        if (document.querySelector(".card__slider")) new core(".card__slider", {
            ...
            pagination: {
                el: ".card__paginations",
                clickable: true
            },
            on: {}
        });
        if (document.querySelector(".catalog-page__slider")) new core(".catalog-page__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: "auto",
            ...
            navigation: {
                prevEl: ".catalog-page__arrow_prev",
                nextEl: ".catalog-page__arrow_next"
            },
            on: {}
        });
    }
    ...
    ymaps.ready((function() {
        var myMap = new ymaps.Map("map", {
            ...
            iconImageHref: "img/icons/location-two.svg",
            iconImageSize: [ 64, 64 ],
    ...
    ymaps.ready((function() {
        var myMap = new ymaps.Map("mapMos", {
            center: [ 54.165136, 37.638782 ],
            zoom: 15.12
        }, {
            searchControlProvider: "yandex#search"
    ...
    if (document.querySelector(".filter-mob__button")) document.querySelector(".filter-mob__button").addEventListener("click", (function(e) {
        if (window.innerWidth < 1100) document.querySelector(".filter-mob__body").classList.toggle("_active-filter");
    }));
    if (document.querySelector(".filter-catalog__title")) document.querySelector(".filter-catalog__title").addEventListener("click", (function(e) {
        if (window.innerWidth < 1100) document.querySelector(".filter-mob__body").classList.remove("_active-filter");
    }));
    const filterContent = document.querySelector(".filter");
    document.addEventListener("click", script_filter);
    function script_filter(event) {
        if (event.target.closest(".item-filter__button")) filterContent.classList.toggle("_action-filter");
        if (!event.target.closest(".filter")) filterContent.classList.remove("_action-filter");
    }
    const filterContentTwo = document.querySelector(".filtertwo");
    document.addEventListener("click", filtertwo);
    function filtertwo(event) {
        if (event.target.closest(".item-filter__button-two")) filterContentTwo.classList.toggle("_action-filter");
        if (!event.target.closest(".filtertwo")) filterContentTwo.classList.remove("_action-filter");
    }
    const filterContentThree = document.querySelector(".filterthree");
    document.addEventListener("click", filterthree);
    function filterthree(event) {
        if (event.target.closest(".item-filter__button-three")) filterContentThree.classList.toggle("_action-filter");
        if (!event.target.closest(".filterthree")) filterContentThree.classList.remove("_action-filter");
    }
    const filterContentFour = document.querySelector(".filterfour");
    document.addEventListener("click", filterfour);
    function filterfour(event) {
        if (event.target.closest(".item-filter__button-four")) filterContentFour.classList.toggle("_action-filter");
        if (!event.target.closest(".filterfour")) filterContentFour.classList.remove("_action-filter");
    }
    window["FLS"] = true;
    isWebp();
    menuInit();
